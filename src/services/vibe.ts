...
export function saveVibeCustomizations(changes: VibeChange[]): void {
  ...
  localStorage.setItem('bapp_vibe_customizations', JSON.stringify(updated));
}

export function loadVibeCustomizations(): VibeChange[] {
  try {
    const stored = localStorage.getItem('bapp_vibe_customizations');
...
export function clearVibeCustomizations(): void {
  localStorage.removeItem('bapp_vibe_customizations');
